    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sand-200 font-sans mt-1">
          Primary credit queue — oldest first.{" "}
          <span className="text-sand-200">
            ...
            <kbd className="font-mono text-xs border border-ink-700 rounded px-1">Enter</kbd> mark credited.
          </span>
        </p>
      </div>
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3">
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-md bg-veld-600 hover:bg-veld-500 text-white px-3 py-1.5 text-sm font-sans font-semibold"
                  >
                    Mark credited
                  </button>
                </div>
